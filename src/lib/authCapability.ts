import type { AuthCapability, AuthCapabilityStatus } from '../types';
...
export const buildMockAuthCapability = (): AuthCapability => ({
  status: 'mock_only',
  ...
  requiredGates: [
    ...
    'Secure token storage adapter must be reviewed.',
