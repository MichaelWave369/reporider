...
- Strengthened safety policy gate with policy version, named checks, warning/blocker counts, and live-write boundary notes
...
6. **Check safety policy** — user sees the strengthened safety policy gate with policy version, scope, named checks, warnings, blockers, and required gates.
...
28. **Guard** — safety checks catch unsafe repo names, public visibility review needs, secrets, dangerous file names, risky defaults, and starter issue risk signals.
